...
// Version: v1
// Description:
//      Merge the raw I/Q data with the data from the fft. The data sting will 
//      have padding to make it into a 128 bit long data string. 
//
//      Designed for ANTSDR e200 to send all the relevant data as one data string to the dma
//
// Parameters:
