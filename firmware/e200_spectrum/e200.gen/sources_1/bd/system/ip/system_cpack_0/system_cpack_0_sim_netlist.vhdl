...
architecture STRUCTURE of system_cpack_0_pack_shell is
  ...
  attribute SOFT_HLUTNM of packed_sync_i_1 : label is "soft_lutpair21";
...
packed_sync_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
entity system_cpack_0 is
  ...
  attribute X_CORE_INFO of system_cpack_0 : entity is "util_cpack2,Vivado 2023.2";
end system_cpack_0;
