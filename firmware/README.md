# Firmware for spectrum analyser
The firmware for this project is build on the firmware from the MicroPhase git repository (https://github.com/MicroPhase/antsdr-fw-patch.git) to get the right firmware follow their installation guide bellow with the additions of changing the the relevant files to create the updated project for the spectrum analyser. Note that this project has used the firmware for e200 and this is strongly suggested to asure that the updated firmware will work
